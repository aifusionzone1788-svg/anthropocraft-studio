  ...
  return (
    <div className="min-h-screen bg-[#050505] px-6 sm:px-8 lg:px-12 py-12 lg:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <FadeUp delay={0.18} yOffset={14} className="my-8">
          <div className="p-4 border border-white/10 bg-[#0c0c0c] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-xs text-zinc-400">
        ...
        <FadeUp delay={0.05} yOffset={24} className="mb-20">
          <div className="border border-white/10 bg-[#0c0c0c] p-8 sm:p-12">
            <div className="mb-10 max-w-xl">
              ...
              <HeadingReveal
                as="h2"
                text="COMMISSION WORKFLOW"
                className="font-display text-2xl sm:text-3xl font-black uppercase text-[#F5F5F5]"
                startTracking="0.06em"
                endTracking="-0.01em"
                glow={true}
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {WORKFLOW_STEPS.map((step, sIdx) => (
                <motion.div
                  ...
                  className="space-y-3 relative will-change-transform"
                >
