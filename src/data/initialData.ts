...
export const INITIAL_CONTACTS: StudioConfig['socials'] = {
  ...
  "twitter": "https://x.com/Anthropocraft12",
  "instagram": "https://instagram.com/Anthropocraft_Studio",
  "artstation": "https://artstation.com/anthrocraft",
  "email": "anthropocraftstudio@gmail.com"
};
...
export const INITIAL_ARTWORKS: Artwork[] = [
  {
    ...
    imageUrl: "https://user30093.na.imgto.link/public/20260906/mascot.avif",
    year: "2026",
    medium: "Digital Mascot Illustration & Brand Identity / 300 DPI",
    description: "Expressive anthropomorphic mascot concept designed with warm blush tones, friendly character gestures, and fluid silhouette suitable for streaming, badges, and brand identity.",
    aspectRatio: "wide",
    createdAt: 1788645000000,
    isUserUploaded: true,
  },
  {
    id: "art-anthro-fullbody-16-1",
    title: "NOCTURNE SLATE FULL-BODY STUDY",
    category: "FULL-BODY ART",
    imageUrl: "https://user30093.na.imgto.link/public/20260906/anthropocraftstudio-16-1.avif",
    year: "2026",
    medium: "Digital Full-Body Character Scene / 300 DPI",
    description: "Atmospheric full-body anthropomorphic composition bathed in oceanic indigo and slate lighting, capturing nuanced pose anatomy and immersive cinematic depth.",
    aspectRatio: "wide",
    createdAt: 1788644800000,
    isUserUploaded: true,
  },
  {
    id: "art-anthro-character-17",
    title: "PASTEL CHARACTER ART STUDY",
    category: "CHARACTER ART",
    imageUrl: "https://user30093.na.imgto.link/public/20260906/anthropocraftstudio-17.avif",
    year: "2026",
    medium: "Digital Character Illustration & Study / 300 DPI",
    description: "Nuanced anthropomorphic character piece rendered in delicate lavender and pastel tones, capturing expressive demeanor, clean linework, and atmospheric illumination.",
    aspectRatio: "square",
    createdAt: 1788644500000,
    isUserUploaded: true,
  },
  {
    id: "art-anthro-portrait-18",
    title: "EMOTIVE CHARACTER HEADSHOT STUDY",
    category: "PORTRAITS",
    imageUrl: "https://user30093.na.imgto.link/public/20260906/anthropocraftstudio-18.avif",
    year: "2026",
    medium: "Digital Character Portrait & Avatar Study / 300 DPI",
    description: "Intimate close-up anthropomorphic portrait capturing expressive gaze, nuanced facial fur textures, and deep atmospheric lighting in balanced square framing.",
    aspectRatio: "square",
    createdAt: 1788644000000,
    isUserUploaded: true,
  },
  {
    id: "art-anthro-custom-19",
    title: "CUSTOM ANTHROPOMORPHIC MASTERWORK",
    category: "CUSTOM ARTWORK",
    imageUrl: "https://user30093.na.imgto.link/public/20260906/anthropocraftstudio-19.avif",
    year: "2026",
    medium: "Custom Character Masterwork / 300 DPI",
    description: "Bespoke custom anthropomorphic artwork showcasing striking anatomical poise, intricate costume elements, and luminous atmosphere tailored to creative client vision.",
    aspectRatio: "tall",
    createdAt: 1788643800000,
    isUserUploaded: true,
  },
  {
    id: "art-anthro-reference-sheet-20",
    title: "CHARACTER MODEL GUIDE & TURNAROUND",
    category: "REFERENCE SHEETS",
    imageUrl: "https://user30093.na.imgto.link/public/20260906/anthropocraftstudio-20.avif",
    year: "2026",
    medium: "Complete Character Turnaround & Spec Sheet / 300 DPI",
    description: "Comprehensive anthropomorphic character model sheet featuring full anatomical turnaround, expressions, accessories, and color swatch hierarchy.",
    aspectRatio: "wide",
    createdAt: 1788643500000,
    isUserUploaded: true,
  },
  {
    id: "art-anthro-character-art-7-1",
    title: "EXPRESSIVE CHARACTER ART STUDY",
    category: "CHARACTER ART",
    imageUrl: "https://user30093.na.imgto.link/public/20260906/anthropocraftstudio-7-1.avif",
    year: "2026",
    medium: "Digital Character Illustration / 300 DPI",
    description: "Expressive anthropomorphic character artwork capturing dynamic demeanor, subtle anatomical nuance, detailed textural rendering, and atmospheric lighting.",
    aspectRatio: "tall",
    createdAt: 1788643200000,
    isUserUploaded: true,
  },
  {
